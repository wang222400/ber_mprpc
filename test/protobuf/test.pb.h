...
class LoginResponse final :
 ...
 public:
  ...
  void set_allocated_result_code(::fixbug::ResultCode* result_code);
  private:
...
// bytes errmg = 2;
inline void ResultCode::clear_errmg() {
  errmg_.ClearToEmpty();
}
inline const std::string& ResultCode::errmg() const {
  // @@protoc_insertion_point(field_get:fixbug.ResultCode.errmg)
  return _internal_errmg();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void ResultCode::set_errmg(ArgT0&& arg0, ArgT... args) {
 
 errmg_.SetBytes(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:fixbug.ResultCode.errmg)
}
inline std::string* ResultCode::mutable_errmg() {
  std::string* _s = _internal_mutable_errmg();
  // @@protoc_insertion_point(field_mutable:fixbug.ResultCode.errmg)
  return _s;
}
inline const std::string& ResultCode::_internal_errmg() const {
  return errmg_.Get();
}
inline void ResultCode::_internal_set_errmg(const std::string& value) {
  
  errmg_.Set(value, GetArenaForAllocation());
}
inline std::string* ResultCode::_internal_mutable_errmg() {
  
  return errmg_.Mutable(GetArenaForAllocation());
}
inline std::string* ResultCode::release_errmg() {
  // @@protoc_insertion_point(field_release:fixbug.ResultCode.errmg)
  return errmg_.Release();
}
inline void ResultCode::set_allocated_errmg(std::string* errmg) {
  if (errmg != nullptr) {
  ...
  // @@protoc_insertion_point(field_set_allocated:fixbug.ResultCode.errmg)
}
...
inline ::fixbug::ResultCode* LoginResponse::release_result_code() {
  ...
  ::fixbug::ResultCode* temp = result_code_;
  result_code_ = nullptr;
...
inline ::fixbug::ResultCode* LoginResponse::mutable_result_code() {
...
inline void LoginResponse::set_allocated_result_code(::fixbug::ResultCode* result_code) {
  ...
  if (result_code) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalGetOwningArena(result_code);
...
inline const ::fixbug::ResultCode& GetFriendListsResponse::_internal_result_code() const {
  const ::fixbug::ResultCode* p = result_code_;
  return p != nullptr ? *p : reinterpret_cast<const ::fixbug::ResultCode&>(
      ::fixbug::_ResultCode_default_instance_);
}
inline const ::fixbug::ResultCode& GetFriendListsResponse::result_code() const {
  // @@protoc_insertion_point(field_get:fixbug.GetFriendListsResponse.result_code)
  return _internal_result_code();
}
inline void GetFriendListsResponse::unsafe_arena_set_allocated_result_code(
    ::fixbug::ResultCode* result_code) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(result_code_);
  }
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:fixbug.GetFriendListsResponse.result_code)
}
inline ::fixbug::ResultCode* GetFriendListsResponse::release_result_code() {
...
inline ::fixbug::ResultCode* GetFriendListsResponse::unsafe_arena_release_result_code() {
  // @@protoc_insertion_point(field_release:fixbug.GetFriendListsResponse.result_code)
  
  ::fixbug::ResultCode* temp = result_code_;
  result_code_ = nullptr;
  return temp;
}
inline ::fixbug::ResultCode* GetFriendListsResponse::_internal_mutable_result_code() {
...
inline ::fixbug::ResultCode* GetFriendListsResponse::mutable_result_code() {
  ::fixbug::ResultCode* _msg = _internal_mutable_result_code();
  // @@protoc_insertion_point(field_mutable:fixbug.GetFriendListsResponse.result_code)
  return _msg;
}
inline void GetFriendListsResponse::set_allocated_result_code(::fixbug::ResultCode* result_code) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete result_code_;
  }
  ...
  result_code_ = result_code;
  // @@protoc_insertion_point(field_set_allocated:fixbug.GetFriendListsResponse.result_code)
}
