...
const uint32_t TableStruct_rpcheader_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::ber_mprpc::RpcHeader, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::ber_mprpc::RpcHeader, service_name_),
  PROTOBUF_FIELD_OFFSET(::ber_mprpc::RpcHeader, method_name_),
  PROTOBUF_FIELD_OFFSET(::ber_mprpc::RpcHeader, args_size_),
};
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, -1, sizeof(::ber_mprpc::RpcHeader)},
};

static const ::_pb::Message* const file_default_instances[] = {
  &::ber_mprpc::_RpcHeader_default_instance_._instance,
};

const char descriptor_table_protodef_rpcheader_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\017rpcheader.proto\022\tber_mprpc\"I\n\tRpcHeade"
...
RpcHeader::RpcHeader(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  SharedCtor();
  // @@protoc_insertion_point(arena_constructor:ber_mprpc.RpcHeader)
}
RpcHeader::RpcHeader(const RpcHeader& from)
  ...
  // @@protoc_insertion_point(copy_constructor:ber_mprpc.RpcHeader)
}
...
RpcHeader::~RpcHeader() {
  // @@protoc_insertion_point(destructor:ber_mprpc.RpcHeader)
...
// @@protoc_insertion_point(message_clear_start:ber_mprpc.RpcHeader)
...
uint8_t* RpcHeader::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:ber_mprpc.RpcHeader)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:ber_mprpc.RpcHeader)
  return target;
}

size_t RpcHeader::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:ber_mprpc.RpcHeader)
  size_t total_size = 0;
...
// @@protoc_insertion_point(class_specific_merge_from_start:ber_mprpc.RpcHeader)
...
// @@protoc_insertion_point(class_specific_copy_from_start:ber_mprpc.RpcHeader)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
template<> PROTOBUF_NOINLINE ::ber_mprpc::RpcHeader*
Arena::CreateMaybeMessage< ::ber_mprpc::RpcHeader >(Arena* arena) {
  return Arena::CreateMessageInternal< ::ber_mprpc::RpcHeader >(arena);
}
